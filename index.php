...
<body>
    <header>
        <div class="logo-bar">
            <div class="logo">
                <img src="https://logojinni.com/image/logos/google-16.svg" alt="google">
                <h2>Privacy e Termini</h2>
            </div>
            <div class="user h-100 d-flex  ">
                <img src="https://banner2.cleanpng.com/20180719/ylf/kisspng-computer-icons-menu-black-dots-5b513debf021e2.9255991715320509239836.jpg" alt="" class="img-fluid">
                <img src="https://toppng.com/uploads/preview/file-svg-user-icon-material-desi-11563317072p2p27gjccw.png" alt=""class="img-fluid rounded">
            </div>
            
        </div>
        <div class="nav-bar w-100">
            <ul class="d-flex align-center w-40 h-100">
                <li>Introduzione</li>
